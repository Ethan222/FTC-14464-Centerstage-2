...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.03164852774253856;
        public double lateralInPerTick = 0.03453870779976717;
        public double trackWidthTicks = 689.6761260243899;

        // feedforward parameters (in tick units)
        public double kS = 1.8865222044782;
        public double kV = 0.0042237151254736266;
        public double kA = .001;

        // path profile parameters (in inches)
        public double maxWheelVel = 40; //65+4;
        public double minProfileAccel = -30;
        public double maxProfileAccel = 20; //85+5;

        // turn profile parameters (in radians)
        public double maxAngVel = Math.toRadians(150); //260+20); // shared with path
        public double maxAngAccel = Math.toRadians(90); //290+20);
    ...
    public static final String FL_NAME = "FL", BL_NAME = "BL", BR_NAME = "BR", FR_NAME = "FR";
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, FL_NAME);
        leftBack = hardwareMap.get(DcMotorEx.class, BL_NAME);
        rightBack = hardwareMap.get(DcMotorEx.class, BR_NAME);
        rightFront = hardwareMap.get(DcMotorEx.class, FR_NAME);
